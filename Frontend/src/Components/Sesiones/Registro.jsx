...
const Registro = () => {
  const [formData, setFormData] = useState({
    ...
    telefono: '',
    fechaNacimiento: '',
    rol: '', // ✅ Valores correctos: 'Emprendedor' o 'Usuario de la universidad'
  ...
  const validateForm = () => {
    ...
    // ✅ AGREGADO: Validar que se seleccione un rol
    if (!formData.rol) {
      newErrors.rol = 'Debes seleccionar un tipo de usuario';
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = {
        ...
        rol: formData.rol, // ✅ Ahora envía el valor correcto
      };
      ...
      console.log('✅ Usuario creado:', userData); // ✅ Debug
